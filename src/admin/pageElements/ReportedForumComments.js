...
import { GetReportedForumCommentsData } from '../datatable/GetReportedForumCom';


export const ReportedForumComments = () => {
                        ...
                        <div className="row forPosSticky">
                            ...
                            <section className="col-lg-12 col-12 mt-3 mt-lg-0 boxShadow">
                                <div className="adminUsersPageHead">
                                    <h6 className="mb-0">Reported forum Comments</h6>
                                </div>
                                <GetReportedForumCommentsData />
                            </section>
                        </div>
                    </div>
                    <Footer />
