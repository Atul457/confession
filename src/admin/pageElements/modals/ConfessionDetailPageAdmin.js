...
import useShareRequestPopUp from '../../../user/utilities/useShareRequestPopUp';


export default function ConfessionDetailPageAdmin({ categories, updatePost, ...rest }) {
    ...
    const _doComment = async () => {
        ...
        try {
            ...
            if (response.data.status === true) {
                ...
                if (totalPages === commentsData.page)   //APPENDS
                {
    ...
    return (
        <>
            <div className="container-fluid postWrapperCommentsModal confession_detail_page">
                {confessionData && comDetailPage.status === apiStatus.FULFILLED
                    ?
