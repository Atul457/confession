...
export const GetReportedCommentsData = () => {
    ...
    const columns = [
        {
            selector: row => row.comment, name: "Reported Comment", sortable: true, minWidth: "350px", maxWidth: "500px",
        },
        {
    ...
    const deleteCommentFunc = async (onfession_id, comment_id) => {

        let confirm = window.confirm("Are you sure, you want to delete this comment?")
        if(!confirm) return 
        let confessionId = onfession_id;
